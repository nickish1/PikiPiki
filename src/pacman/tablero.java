...
public class tablero extends JPanel implements ActionListener {
    private Dimension d;
    private final Font smallfont = new Font("Helvetica", Font.BOLD, 19);

    private Image ii;
    private final Color dotcolor = new Color(193, 123, 65);
    ...
    private final int pacanimdelay = 1;
    ...
    private void showIntroScreen(Graphics2D g2d) {
        ...
        g2d.setColor(new Color(32, 234, 21));
        g2d.fillRect(50, scrsize / 2 - 30, scrsize - 100, 50);
        g2d.setColor(Color.white);
        g2d.drawRect(50, scrsize / 2 - 30, scrsize - 100, 50);

        String s = "Нажмите S для начала игры.";
    ...
    private void drawScore(Graphics2D g) {
        ...
        g.setFont(smallfont);
        g.setColor(new Color(34, 43, 255));
        s = "Очки: " + score;
        g.drawString(s, scrsize / 2 + 80, scrsize + 16);
    ...
    private void moveGhosts(Graphics2D g2d) {//двигает приведений
    ...
    private void continueLevel() {
        ...
        for (i = 0; i < nrofghosts; i++) {
            ...
            ghosty[i] = 4 * blocksize; //c положения  монстров 
        ...
        pacmanx = 7 * blocksize;//положене пики пики 
